...
export const   EditCurso = () => {
  ...
  useEffect(() => {
    const obtenerDetallesCurso = async () => {
      try {
        const respuesta = await fetch(`http://localhost:3000/api/v1/curso/${id}`);
  ...
  const handleGuardar = async () => {
    try {
      ...
      // Asumiendo que la respuesta contiene los datos actualizados del curso
      const datosActualizados = await respuesta.json();

      // Actualizamos el estado local del curso con los datos actualizados
      ...
      <form>
        <div className="container alMedio">
          ...
          <div className="row alMedio">
            ...
            <div className="col-3 izquierda">
              <input type="text" name="fechaInicio" value={curso.fechaInicio} onChange={handleChange} />
            </div>
          </div>
          <div className="row alMedio">
            <div className="col-3 izquierda">
          ...
          <div className="row alMedio">
            ...
            <div className="col-3 izquierda">
              <input type="text" name="horario" value={curso.horario} onChange={handleChange} />
            </div>
          </div>
          <div className="row alMedio">
            <div className="col-3 izquierda">
