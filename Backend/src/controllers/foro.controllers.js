...
export const comment = async (req, res) => {
  ...
  export const updateCommentById = async (req, res) => {
    ...
    try {
        ...
        const updateComment = await Comment.findByIdAndUpdate(id, { comentario }, { new: true });
        ...
        res.json({ code: 200, message: "Comentario actualizado con éxito.", commentId: updateComment._id, token: req.token });
    } catch (error) {
...
export const deleteCommentById = async (req, res) => {
    ...
    try {
        ...
        res.json({ message: 'Comentario eliminado correctamente', token: req.token  });
    } catch (error) {
